...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'Renat.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/Renat.html'`` the file from the app1 package is loaded,
    by loading ``'app2/Renat.html'`` the file from the second.
    """
